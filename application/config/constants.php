...
define("DEFAULT_TITLE_ADMIN","WM Électricité");

//if($_SERVER['SERVER_NAME']=="87.66.16.17" || $_SERVER['SERVER_NAME']=="27.0.0.1"){
	define('SURL','http://'.$_SERVER['HTTP_HOST'].'/erp/');
/*}else{
	define('SURL', 'http://87.66.16.17:7080/erp/'); // highest automatically-assigned error code
}*/
