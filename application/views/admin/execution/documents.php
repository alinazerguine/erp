            ...
            <table class="table table-striped" id="exec_document_table">
              ...
              <tbody>
                ...
                <tr>
                   ...
                   <?php ?>
                  <td width="30%"><a href="<?php echo $data->document_url;?>" target="_blank"><img src="<?php echo SURL.'assets/images/pdf.png'?>" style="width: 10%;"><?php //echo $data->document_url;?></a></td>
...
<div class="col-md-12 col-sm-12" style="text-align: right; padding-top: 10px;">  
  <a href="<?php echo SURL.'admin/execution/detail/'.$offer_id?>"><span class="label btn_6 label-danger medium"><?php echo BACK_BTN;?></span></a>
</div> 
</div>
</div>
</div>
