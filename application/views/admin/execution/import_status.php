<div id="page-wrapper">
  ...
  ?>	
        ...
        <!-- offer title top -->
       <div class="col-md-12 col-sm-12" style="background-color: #444;padding: 5px;color: #FFF;font-size: 14px;">         <div class="col-md-7 medium"><?php echo 'Chantier';?> #<?php echo $executed_sites->reference_no;?> | <?php echo $executed_sites->description;?></div>
       
      <div class="col-md-5">
       
        <div class="float-right" style="margin-top: 5px; margin-right: 10px;">
          <div class="add-block"><?php echo MANAGER;?> : <?php echo $executed_sites->site_manager;?> </div>       
        </div>          
      </div>
    </div>
    <!-- detail -->
    <div class="col-md-12 col-sm-12" style="text-align: center; padding-bottom: 16px; margin-top: 10px;">
      ...
      <div class="col-md-4">
        <form method="post" action="<?php echo SURL.'admin/execution/import_status/'.$executed_sites->id;?>" enctype="multipart/form-data">
  ...
  <form method="post" action="<?php echo SURL.'admin/execution/save_invoice'?>">
    <input type="hidden" name="progress_state" value="<?php echo $progress_state;?>">
     <input type="hidden" name="start_period" value="<?php echo $start_period;?>">
      ...
      <input type="hidden" name="site_id" value="<?php echo $executed_sites->id;?>">
  <div class="col-md-12 col-sm-12" style="padding-top: 20px;border-bottom: 1px solid #444;padding-left:  0px;padding-right: 0px;">           
   <div class="col-md-7" style="border-right: 1px solid #444;min-height: 370px;">
     <div class="form-group">
      ...
      <input type="text" class="form-control" name="refference" id="refference" value="<?php echo $reference;?>" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="total_vat_exc" name="total_without_vat" value="<?php echo $period_bill;?>" required>
    </div> 

    <div class="form-group">
      <label for="vat"><?php echo VAT_TEXT;?> :</label>
      <input type="text" class="form-control" id="vat" name="vat" value="<?php echo $vat;?>" required>
    </div>
    <div class="form-group">
      <label for="total"><?php echo TOTAL_TVAT;?> :</label>
      <input type="text" class="form-control" id="total" name="total_with_vat" value="<?php echo $total_with_vat;?>" required>
    </div>             
...
<div class="col-md-12 col-sm-12" style="text-align: center; padding-top: 10px;">
  ...
  <a href="<?php echo SURL.'admin/execution/detail/'.$executed_sites->id;?>"> <span class="label btn_7 label-danger medium"><?php echo CANCEL_BTN;?></span></a>
</div>  
</form>          
