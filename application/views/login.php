				...
				<div class="graphs">
					<div class="sign-in-form">
						<div class="sign-in-form-top">
							...
							<img src="<?php echo base_url('assets/images/logo.jpg');?>" alt="Electrolite logo" style="height: 150px;"  />
						</div>						
						<div class="signin">
							<?php
			      ...
			      if ($this->session->flashdata('ok_message')) {
			        ?>
			          ...
			          ?>
							<form method="post" action="<?php echo SURL.'login/sign_in'?>">
								<!-- <div class="log-input">
								<div class="log-input-left">
								   <select class="form-control1" name="user_type">
								   	<option value="">--User--</option>
								   	<option value="1">Administrator </option>
								   	<option value="2">Head of construction sites</option>
								   	<option value="3">Head of human resources</option>
								   </select>
								</div>
							...
							<div class="log-input">
								<div class="log-input-left">
								   <input type="email" class="user" name="login_email" placeholder="Email" value="" />
								</div>
							...
							<div class="log-input">
								<div class="log-input-left">
								   <input type="password" name="password" class="lock" placeholder="Password" value="" />
								</div>
						...
						<div class="signin-rit">
								<span class="checkbox1">
									 <label class="checkbox" style="width: 100%;"><?php echo FORGOT_PASSWORD;?>? <a href="<?php echo base_url('login/forgot_password');?>"><?php echo CLICK_HERE;?></a></label>
								</span>								
								<div class="clearfix"> </div>
							</div>
						</div>
