      ...
      <div class="bs-example4" data-example-id="simple-responsive-table" style="padding-left: 0px; padding-right: 0px; padding-top: 0px;">
        ...
        <tfoot>
          <tr>
            <th></th>
            <th></th>
            <th><span class="label btn_6 label-success medium"><?php echo TOTAL_WORK_PROGRESS;?> : <?php echo numberFormat($resultant1 + $resultant2).CURRENCY;?></span>
            </th>
...
<div class="col-md-12 col-sm-12" style="text-align: right; padding-top: 10px;">  
  <a href="<?php echo SURL.'site_manager/sites/detail/'.$offer_id?>"><span class="label btn_6 label-danger medium"><?php echo BACK_BTN;?></span></a>
</div> 
</div>
</div>
</div>
