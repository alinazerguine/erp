<div id="page-wrapper">
  <div class="graphs" style="float: left; width: 100%;">    
    <div class="xs tabls">      
      <div class="bs-example4" data-example-id="simple-responsive-table" style="padding-left: 0px; padding-right: 0px; padding-top: 0px;">
        <!-- offer title top -->
       <div class="col-md-12 col-sm-12" style="background-color: #444;padding: 5px;color: #FFF;font-size: 14px;">         <div class="col-md-7 medium"><?php echo OFFER;?> #<?php echo $executed_sites->reference_no;?> | <?php echo $executed_sites->description;?></div>
       
      <div class="col-md-5">
       
        <div class="float-right" style="margin-top: 5px; margin-right: 10px;">
          <div class="add-block"><?php echo MANAGER;?> : <?php echo $executed_sites->manager_name;?> </div>       
        </div>          
      </div>
    </div>
    <!-- detail -->
    <div class="col-md-12 col-sm-12" style="text-align: center; padding-bottom: 16px; margin-top: 10px;">
      ...
      <div class="col-md-4">
        <form method="post" action="<?php echo SURL.'site_manager/sites/import_status/'.$executed_sites->id;?>" enctype="multipart/form-data">
  ...
  <form method="post" action="<?php echo SURL.'site_manager/sites/save_invoice'?>">
...
<div class="col-md-12 col-sm-12" style="text-align: center; padding-top: 10px;">
  ...
  <a href="<?php echo SURL.'site_manager/sites/detail/'.$executed_sites->id;?>"> <span class="label btn_7 label-danger medium"><?php echo CANCEL_BTN;?></span></a>
</div>  
</form>          
